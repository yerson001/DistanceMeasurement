        ...
        for classId, confidence,box in zip(classIds.flatten(),confs.flatten(),bbox):
            ...
            if className in objects:
                ...
                if (draw and classId==47):
                    ...
                    cv2.putText(img,"Frasco",(box[0]+10,box[1]+30),cv2.FONT_HERSHEY_COMPLEX,0.7,(0,0,255),2)
                    #cv2.putText(img,str(round(confidence*100,2)),(box[0]+200,box[1]+30),cv2.FONT_HERSHEY_COMPLEX,1,(0,255,0),2)
                    img = cv2.circle(img, (box[0],box[1]),10,(0,0,255), thickness=2)
                    img = cv2.circle(img, (box[0]+box[2],box[1]),10,(0,0,255), thickness=2)
...
if __name__ == "__main__":
    ...
    #cap = cv2.VideoCapture("/home/y3rsn/Dev/py/stereo/video2.webm")
    cap.set(3,640)
    cap.set(4,480)
    #cap.set(10,70)
    ...
    while True:
        ...
        Distance = (W*f)/w
        #Distance = 30
        cv2.putText(img, f"Distance = {round(Distance,2)} CM", (50, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (255,255,255), 2)
